...
- [Networking](/wiki/networking/) - Log sources (firewall, DNS)
- [Virtualization](/wiki/virtualization/) - Where monitoring runs
- [Automation](/wiki/automation/) - Alert automation
